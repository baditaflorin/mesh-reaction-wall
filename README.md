...
[![pages](https://img.shields.io/badge/live-baditaflorin.github.io%2Fmesh--reaction--wall-8046a5)](https://baditaflorin.github.io/mesh-reaction-wall/)
[![version](https://img.shields.io/badge/version-0.1.0-blue)](https://github.com/baditaflorin/mesh-reaction-wall/blob/main/package.json)
[![license](https://img.shields.io/badge/license-MIT-green)](./LICENSE)

> A shared, de-duplicated reaction wall.

**Live → https://baditaflorin.github.io/mesh-reaction-wall/**

**Source → https://github.com/baditaflorin/mesh-reaction-wall**
...
git clone https://github.com/baditaflorin/mesh-reaction-wall
cd mesh-reaction-wall
npm install
npm run dev
```
...
- `mesh-reaction-wall:signalingUrl`
- `mesh-reaction-wall:turnTokenUrl`
- `mesh-reaction-wall:iceServers`
- `mesh-reaction-wall:room`
